...
export class input8a extends Component {
    ...
    handelSubmitMarks=(marks)=>{
        ...
        console.log(s1.students[s1.totIndex].totalMarks.reduce((acc,curr)=>acc+parseInt(curr.math)+parseInt(curr.eng)+parseInt(curr.comp)+parseInt(curr.science),0))
        ...
        :
          <div className="container">
             ...
             {students.map((ele,index)=>
                ...
                <td className="col1">{ele.totalMarks.reduce((acc,curr)=>acc+parseInt(curr.math)+parseInt(curr.eng)+parseInt(curr.comp)+parseInt(curr.science),0)}</td>

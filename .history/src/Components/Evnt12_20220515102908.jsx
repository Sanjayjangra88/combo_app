    ...
    return (
      ...
      <div className="container">
         <div className="row border bg-dark text-white">
          <div className="col-5 border"onClick={() => this.sort(0)}>Title</div>
          <div className="col-4 border text-center"onClick={() => this.sort(1)}>Gerns</div>
          <div className="col-2 border text-center"onClick={() => this.sort(2)}>Stock</div>
          <div className="col-2 border text-center"onClick={() => this.sort(3)}>Rating</div>
          </div>
          {movies.map((p1) => {
            ...
            return(
              ...
              <div className="col-4 border text-center">{gerns}</div>
              <div className="col-2 border text-center">{stock}</div>
              <div className="col-2 border text-center">{rating}</div>
              </div>
              )
            })}

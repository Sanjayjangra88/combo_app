...
export class leftPanel extends Component {
  ...
  handelChange=(e)=>{
      ...
      input.name==="brand" 
      ? (s1.brand = this.upDateCBs(input.checked,input.value,s1.brand)) : input.name === "ram" ? (s1.ram = this.upDateCBs(input.checked,input.value,s1.ram)) :(s1[input.name] = input.value);

...
export class messagingApp extends Component {
    ...
    all=()=>{
        let s1={...this.state};
      let str=  s1.data.filter((ele)=>ele)
        s1.data=str;
        this.setState(s1)
        console.log(str)
    }
  ...
  render() {
    ...
    return (
        <React.Fragment>
      <MessagingFolder data={data}all={this.all}inbox={this.inbox}social={this.social}sent={this.sent}/>
      <Message data={data}all={this.all}inbox={this.inbox}social={this.social}sent={this.sent}/>
      </React.Fragment>
    )

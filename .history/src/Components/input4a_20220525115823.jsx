...
export class input4a extends Component {
    ...
    showCourseDetails=()=>{
        console.log("hy")
        let {courses,viewCourseIndex}=this.state;
        ...
        <button className='btn btn-primary btn-sm mr-2'onClick={()=>this.handelStudentForm()}>Enroll more Students</button>              
        <button className='btn btn-primary btn-sm mr-2'onClick={()=>this.handelStudentForm()}>Lists of More Course</button>              
  ...
  render() {
    ...
    return view === 0 ? (
      ...
      edit={coursesIndex >=0}
      />
    ):view===2 ? this.showCourseDetails():this.showEnrolStudents();
  }
}

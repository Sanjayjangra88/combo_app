  ...
  render() {
    ...
    return (
        ...
        <div className="container text-center">
            ...
            <button  className="btn btn-warning btn-sm m-2">View Table</button>
            </div>
          ...
          {products.map((ele,index1)=>
          <ProductTable products={ele} index={index1}Increment1={this.handelIncrement1}Decrement1={this.handelDecrement1}/>
          )}

      ...
      <React.Fragment>
       ...
       <div className="row">
        ...
        <div className='row text-center'>
          ...
          <div className="container">{cart.map((ele,index)=><ul><li>{ele.name},Quantity:{ele.qty}<button className="btn btn-light btn-sm m-2"onClick={() =>onCart(index)}>Remove from Cart</button></li></ul>)
          }</div>}

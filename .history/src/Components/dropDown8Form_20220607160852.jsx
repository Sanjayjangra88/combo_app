  ...
  render() {
    ...
    return (
        ...
        <div className="form-check form-check-inline">
                ...
                <input type="text"className="form-control"name="company"id="company"value={company} placeholder='Enter the Company Name'onChange={this.handelChange} />
                ...
                <input type="text"className="form-control"name="college"id="college"value={college} placeholder='Enter the College Name'onChange={this.handelChange} />
                <label>Course</label>

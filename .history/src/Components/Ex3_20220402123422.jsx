  ...
  render() {
    ...
    return (
        <div className='col-3 border bg-warning'>
          ...
          English:{students[0].english}<br/>
          Maths:{students[0].maths}<br/>
          Computer:{students[0].computer}<br/>
          Total Marks:{this.totalMarls(students[0].english,students[0].maths,students[0].computer)}
            </div>
    )
  }
}

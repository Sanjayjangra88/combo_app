      ...
      return (
        ...
        <div className="container">
           <div className="row border bg-dark text-white">
            ...
            <div className="col border text-center">Price</div>
            <div className="col border text-center">Sales</div>
            <div className="col border text-center">Value</div>
            </div>
            {products.map((p1) => {
              ...
              return(
                ...
                <div className="col border text-center">{price}</div>
                <div className="col border text-center">{sales}</div>
                <div className="col border text-center">{price*sales}</div>
                </div>

...
export class input8a extends Component {
    ...
    handelSubmitMarks=(marks)=>{
        ...
        // : 
       s1.totIndex >= 0 ?s1.students[s1.totIndex].totalMarks=marks:
  ...
  render() {
    ...
    return(
     ...
     :view===3?
     <Input8c marks={totIndex >= 0 ? students[totIndex].totalMarks:marks} onSubmitMarks={this.handelSubmitMarks}name={name}/>:""
     }

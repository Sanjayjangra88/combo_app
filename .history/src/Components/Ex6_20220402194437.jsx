    ...
    <div className='container'>
     {employees.map((p1)=>{
         ...
         return(
           ...
           <div className="col-6 col-sm-3 border">{name} </div>
           <div className="col-6 col-sm-2 border">{level} </div>
           <div className="col-6 col-sm-2 border">{dept} </div>
            <div className="col-6 col-sm-2 border">{designation}</div>
           <div className="col-6 col-sm-2 border">{salary}</div> 
            </div>
            )
     })
    }

...
export class input8c extends Component {
    ...
    handelSubmit=(e)=>{
        ...
        // console.log(this.state.marks)
         let str=  this.state.marks.reduce((acc,curr)=>acc+parseInt(curr.math)+parseInt(curr.eng)+parseInt(curr.comp)+parseInt(curr.science),0)
         this.state.marks=str;
         this.setState(this.state.marks)

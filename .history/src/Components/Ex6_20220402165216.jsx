    ...
    <div className='container'>
     {employees.map((p1)=>{
         ...
         return(
           ...
           <div className="col-7 border">NAME        {name} </div>
           <div className="col-5 border">LEVEL       {level} </div>
           <div className="col-5 border">DEPT        {dept} </div>
           <div className="col-5 border">DESIGINATION{designation}</div>
           <div className="col-5 border">SALARY      {salary}</div>
            </div>
            )
     })
    }

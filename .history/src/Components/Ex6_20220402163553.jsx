    ...
    <div className='row-6'>
     {employees.map((p1)=>{
         ...
         return(
           ...
           <div className="col-3"> LEVEL:       {level} </div>
           <div className="col-3"> DEPT :       {dept} </div>
           <div className="col-3"> DESIGINATION:{designation},</div>
           <div className="col-3">SALARY:      {salary}</div>
            </div>
            )
     })
    }

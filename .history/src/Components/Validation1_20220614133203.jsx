...
import Validation1Form from './validation1Form';

export class validation1 extends Component {
    state={
        persons:[
            ...
            return(
                <div className="container">
                    {view === 0 ? (
                        ...
                        <Validation1Form person={editPersonIndex>=0 ?persons[editPersonIndex]:{}}

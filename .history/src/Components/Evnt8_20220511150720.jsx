  ...
  render() {
    ...
    return (
          ...
          <React.Fragment>
            ...
            <button className="btn btn-primary m-2"id="abc"onClick={() => this.tot2(true)}>Add</button>
            <button className="btn btn-primary m-2"id="bcd"onClick={() => this.tot2(false)}>Multiply</button>
            </div>
            {numbers.map((p1) => (

...
export class Evnt12 extends Component {
    ...
    delete=(p1)=>{
        const {movies}=this.state;
        let a2 ={...this.state.movies}
     let str= movies.splice(p1,1)
       a2.movies=str;
        this.setState(a2);
         ...
         <div className="row border bg-white text-dark">
          ...
          {movies.map((p1,i) => {
            ...
            return(
             ...
             <div className="col-2"> <button className="btn btn-danger m-2" onClick={()=>this.delete.bind(this)}index={i}>Delete</button></div>

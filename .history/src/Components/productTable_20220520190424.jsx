...
export class productTable extends Component {
    render() {
        const{products,Increment1,Decrement1,index1}=this.props;
      ...
      return (
        ...
        <div className="col-1"><button  className="btn btn-success btn-sm "onClick={() =>Increment1(index1)}>+</button></div>
        <div className="col-1"><button disabled={quantity<1} className="btn btn-danger btn-sm "onClick={() =>Decrement1(index1)}>-</button></div>

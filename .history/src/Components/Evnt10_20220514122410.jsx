...
export class Evnt10 extends Component {
    ...
    sort=(colnum)=>{
      ...
      colnum==0? products.sort((p1,p2)=>p1.name.localeCompare(p2.name)):
      colnum==1> products.sort((p1,p2)=>(+p1.price)-(+p2.price));
      // colnum==2: products.sort((p1,p2)=>(+p1.sales)-(+p2.sales));
      // colnum==3: products.sort((p1,p2)=>(+p1.price*p1.sales)-(+p2.price*p2.sales));

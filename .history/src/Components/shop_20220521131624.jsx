...
export class shop extends Component {
    render() {
    const {mobiles,onCart,cart,onRemove,id}=this.props;
    return (
      <React.Fragment>
      ...
      <div className="row">
        <div className='row text-center'>
          ...
          <div className="container">{cart.map((ele)=><ul><li>{ele.name},Quantity:{ele.qty}<button className="btn btn-primary btn-sm m-2"onClick={() =>onRemove(id)}>Remove from Cart</button></li></ul>)
          }</div>}

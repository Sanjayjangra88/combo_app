...
class Ex7 extends Component {
  ...
  employee =(emp)=>{
    ...
    // const st1 = a1.filter((name)=>name.designation==="Manager"); //////////////filer by designation
    // const st1 = a1.filter((name)=>name.level>2);///////////////// level greater than 2  
    a1.sort((s1,s2)=>s1.level-s2.level);
      console.log(st1);

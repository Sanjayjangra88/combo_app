        ...
        :
          <div className="container">
             ...
             {students.map((ele,index)=>
                ...
                <td className="col1">{ele.totalMarks.reduce((acc,curr)=>acc+parseInt(curr.math)+parseInt(curr.eng)+parseInt(curr.comp)+parseInt(curr.science),0)===0?<button className='btn btn-danger btn-sm'onClick={()=>this.total(index)}>{ele.totalMarks===0?"Enter":"Done"}</button>:"Done"}</td>
            </tr>

             ...
             <div className="row border bg-dark text-white">
              ...
              {products.map((p1) => {
                ...
                return(
                  ...
                  <div className="col-3 border text-center">{price}</div>
                  <div className="col-3 border text-center">{quantity}</div>
                  <div className="col-3 border text-center"><button  className="btn btn-light btn-sm m-2"onClick={() =>Increment()}>+</button></div>
                  <div className="col-3 border text-center"></div>
                  </div>
                  )
                })}

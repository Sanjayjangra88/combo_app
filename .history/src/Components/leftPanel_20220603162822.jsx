...
export class leftPanel extends Component {
  ...
  render() {
      const{optionArry,optionSell,remove,brand,ram}=this.props;
      console.log(brand);
    ...
    return (
      <div className='container'>
         ...
         <label className='form-check-label font-weight-bold'>Brand</label>
       ...
       {/* {this.showCheckBoxes("Brands",optionArry.brand,"brand",optionSell.brand)} */}
          {this.showDrop("Ram",optionArry.ram,"ram",ram)}
  ...
  showDrop=(label,arr,name,ram)=>{
      return(
          <React.Fragment>
          <div className="container">
         <div className="form-group">
         <label className='form-check-label font-weight-bold'>{label}</label>
         <select className="form-control"name={name}value={ram}onChange={this.handelChange}>
        <option disabled value="">Select the Ram</option>

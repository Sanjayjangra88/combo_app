        ...
        <div className="row">
          ...
          <div className="row border bg-warning">
            <div className="col-6 text-center">
              ...
              <div className="container">Tech : {this.tech()} 
              <div className="container">Fin : {this.fin()} 
              <div className="container">Ops: {this.ops()} 
            </div>
            </div>
            </div>
            </div>
            ...
            <div className="col-3 text-center">
              ...
              <div className="container">
                Average Salary : {this.avrgSlry()}
              </div>
              <div className="container">Max Salary : {this.maxSlry()}</div>
              <div className="container">Min Salary : {this.minSlry()}</div>
            </div>
          </div>
        </div>
      </div>

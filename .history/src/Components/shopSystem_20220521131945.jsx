...
export class shopSystem extends Component {
    ...
    handelRemove=(index)=>{
        let s1={...this.state};
        let ele = s1.cart[index]
        let x1 = s1.cart.find((c1) => c1.name === ele.name);
        console.log(x1)
        // s1.cart.splice(ele,1)
        // this.setState(s1);
  ...
  render() {
      ...
      return (
      <Shop mobiles={mobiles}onCart={this.handelCart}cart={cart}onRemove={this.handelRemove
}/>
      )
  }
}

  ...
  render() {
    ...
    return (
      <div className='container'>
          ...
          {cart.length>0?cart.map((ele)=><ul><li>{ele.name},Qunatity {ele.qty}<button className="btn btn-success btn-sm m-2">Remove Cart</button></li><h5>Number of Items in Cart{ele.qty.length}</h5></ul>):"Cart is Empty"}
          <br/>

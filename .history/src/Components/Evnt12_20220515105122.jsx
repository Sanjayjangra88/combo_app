    ...
    return (
      ...
      <div className="container">
         <div className="row border bg-white text-dark">
          ...
          <div className="col-2  text-center"onClick={() => this.sort(2)}>Stock</div>
          <div className="col-2  text-center"onClick={() => this.sort(3)}>Rating</div>
          ...
          {movies.map((p1) => {
            ...
            return(
             ...
             <div className="col-2"> <button className="btn btn-danger" onClick={()=>this.foodSort()}>Delete</button></div>

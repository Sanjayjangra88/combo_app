...
export class dropDown2 extends Component {
    ...
    render(){
        const{name,age,country,gender,passport,licence,city,passportNumber}=this.state.persons;
        const{countrys,countryList}=this.state;
        ...
        return(
            <div className="container">
                ...
                {passport? <div className="form-group">
                    ...
                    <input type="text"className="form-control"name="passport"id="passport"placeholder='Enter the passport Number'value={passportNumber}onChange={this.handelChange} />
                </div>:""}
                <div className="form-check">

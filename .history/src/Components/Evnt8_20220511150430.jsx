  ...
  render() {
    ...
    return (
          ...
          <React.Fragment>
            ...
            <button className="btn btn-primary m-2"onClick={() => this.tot2(true)}>Add</button>
            <button className="btn btn-primary m-2"onClick={() => this.tot2(false)}>Multiply</button>
            </div>
            {numbers.map((p1) => (

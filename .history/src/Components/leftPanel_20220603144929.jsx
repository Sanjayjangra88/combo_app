...
export class leftPanel extends Component {
  ...
  render() {
    ...
    //   const{brand}=this.props.optionSell;
    //   console.log(remove)
    return (
      <div className='container'>
          ...
          <label>Brands</label>
          <select className="form-control"name={brand}id="brand"value={optionSell.brand}onChange={this.handelChange}>

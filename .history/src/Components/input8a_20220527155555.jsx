        ...
        :
          <div className="container">
             ...
             {students.map((ele,index)=>
                <tr>
                <td className="th1">{ele.name}</td>
                <td className="th1">{ele.course}</td>
                <td className="th1">{ele.year}</td>
                <td className="th1"><button className='btn btn-danger btn-sm'onClick={()=>this.edit(index)}>Edit</button></td>
            </tr>

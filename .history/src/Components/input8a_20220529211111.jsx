        ...
        :
          <div className="container">
             ...
             {students.map((ele,index)=>
                ...
                <td className="col1">{totIndex>=0?<button className='btn btn-danger btn-sm'onClick={()=>this.total(index)}>Enter</button>:<button className='btn btn-danger btn-sm'onClick={()=>this.edit(index)}>Edit</button>}</td>
            </tr>

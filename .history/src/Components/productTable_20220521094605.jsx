             ...
             <div className="row border bg-dark text-white">
              ...
              {products.map((p1) => {
                ...
                return(
                  ...
                  <div className="col-2  text-center">{price}</div>
                  <div className="col-2  text-center">{quantity}</div>
                  <div className="col-1  text-center"><button className="btn btn-success btn-sm m-2"onClick={() =>Increment()}>+</button></div>
                  <div className="col-1  text-center"><button className="btn btn-danger btn-sm m-2"onClick={() =>Increment()}>-</button></div>
                  </div>
                  )
                })}

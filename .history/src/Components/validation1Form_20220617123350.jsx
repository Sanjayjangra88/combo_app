...
export class validation1Form extends Component {
    ...
    handelValidate=(e)=>{
          ...
          let s1={...this.state};
          switch (input.name){
              case "name":s1.errors.name = this.validateName();
              break;
              case "age":s1.errors.age = this.validateAge();
              break;
              case "country":s1.errors.country = this.validateCountry();
              break;
              default:
              break;
  ...
  render() {
    ...
    return (
               ...
               <br/>
                ...
                <br/>
                <button className='btn btn-primary'onClick={this.handelSubmit}disabled={!this.isValidForm()}>Submit</button>
            </div>
    )
  }
}

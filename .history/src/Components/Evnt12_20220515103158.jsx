    ...
    return (
      ...
      <div className="container">
         <div className="row border bg-dark text-white">
          <div className="col-6 border"onClick={() => this.sort(0)}>Title</div>
          <div className="col-3 border text-center"onClick={() => this.sort(1)}>Gerns</div>
          ...
          {movies.map((p1) => {
            ...
            return(
              ...
              <div className="col-7 border">{title}</div>

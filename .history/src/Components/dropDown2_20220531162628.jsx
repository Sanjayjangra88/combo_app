...
export class dropDown2 extends Component {
    ...
    render(){
        const{name,age,country,gender,passport}=this.state.persons;
        ...
        return(
            <div className="container">
                ...
                <div className="form-check">
                    <input className="form-check-input"type="checkbox"name="passport"checked={passport}onChange={this.handelChange}/>

...
export class input8a extends Component {
    state={
        students:[{name:"Sanjay",course:"MCa",year:"second",totalMarks:[]}],
        view:0,
        total:[],
        viewIndex:-1,
        totIndex:-1,
    ...
    handelSubmitMarks=(marks)=>{
        let s1={...this.state};
        // s1.totIndex >= 0
        // ? (s1.students[s1.viewIndex].totalMarks=marks[s1.viewIndex].totalMarks)
        // : 
  ...
  render() {
      ...
      let marks={math:"",eng:"",comp:"",science:"",totalMarks:[]}
    ...
    return(
        ...
        :
          <div className="container">
             ...
             {students.map((ele,index)=>
                ...
                <td className="col1">{s1.totIndex>=0?<button className='btn btn-danger btn-sm'onClick={()=>this.total(index)}>Enter</button>:<button className='btn btn-danger btn-sm'onClick={()=>this.edit(index)}>Edit</button>}</td>
            </tr>
     ...
     :view===2?
     <Input8b student={student}edit={viewIndex>=0} onSubmit={this.handelSubmit}/>
     :view===3?
     <Input8c marks={viewIndex >= 0 ? students[viewIndex].totalMarks:marks} onSubmitMarks={this.handelSubmitMarks}name={name}/>:""
     }

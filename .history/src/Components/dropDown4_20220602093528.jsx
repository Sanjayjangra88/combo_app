    ...
    showLaptops=()=>{
        ...
        return(
            <div className="container">
                {laptops.map((ele)=>(
                    <div className="row">
                        <div className="col-2">{ele.model}</div>
                        <div className="col-2">{ele.brand}</div>
                        <div className="col-2">{ele.ram}</div>
                        <div className="col-2">{ele.hardDisk}</div>
                        <div className="col-2">{ele.rating}</div>
                        <div className="col-2">{ele.processor}</div>
                    </div>
                ))}
            </div>
        )

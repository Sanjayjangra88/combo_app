...
class Ex3 extends Component {
  ...
  render() {
    ...
    return (
         <div className='col-3 border bg-warning'>
          ...
          Total Marks:{this.totalMarls(english,maths,computer)}<br/>
          Grade {this.grade(this.totalMarls(english,maths,computer))}<br/>
            </div>
  ...
  render() {
    let {students}=this.state;
    let {name,english,computer,maths} = students[1];
  ...
  return (
       <div className='col-3 border bg-warning'>
        ...
        Computer:{computer}<br/>
        Total Marks:{this.totalMarls(english,maths,computer)}<br/>
        Grade {this.grade(this.totalMarls(english,maths,computer))}
          </div>

    ...
    <div className='container'>
     {employees.map((p1)=>{
         ...
         return(
           ...
           <div className="col-10 border">NAME        {name} </div>
           <div className="col-4 border">LEVEL       {level} </div>
           <div className="col-4 border">DEPT        {dept} </div>
           <div className="col-4 border">DESIGINATION{designation}</div>
           <div className="col-4 border">SALARY      {salary}</div>
            </div>
            )
     })
    }

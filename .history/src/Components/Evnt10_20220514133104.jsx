...
export class Evnt10 extends Component {
  ...
  render() {
      ...
      return (
        <React.Fragment>
          <h3>{cng}</h3><br/>
          <button className="btn btn-primary m-2" onClick={()=>this.onClick(123)}>Price{'>'}=15</button>
          <button className="btn btn-primary m-2" onClick={()=>this.onClick(123)}>Sales{'>'}=10</button>
          <button className="btn btn-primary m-2" onClick={()=>this.onClick(123)}>Value{'>'}=100</button>

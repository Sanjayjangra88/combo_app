      ...
      (students.length===0
        ...
        :
          <div className="container">
              <tr className='row bg-success text-white'>
             ...
             {students.map((ele,index)=>
                ...
                <div className="col-3 border">{ele.course}</div>
                <div className="col-3 border">{ele.year}</div>
                <div className="col-3 border"><button className='btn btn-danger btn-sm'onClick={()=>this.edit(index)}>Edit</button></div>
            </div>

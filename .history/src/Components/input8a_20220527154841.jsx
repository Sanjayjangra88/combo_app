        ...
        :
          <div className="container">
             ...
             {students.map((ele,index)=>
                ...
                <td className="border">{ele.year}</td>
                <td className="border"><button className='btn btn-danger btn-sm'onClick={()=>this.edit(index)}>Edit</button></td>
            </tr>

...
export class input8a extends Component {
    ...
    handelSubmitMarks=(marks)=>{
       ...
       ?(s1.students[s1.viewIndex].totalMarks=marks):
        ...
        s1.total=s1.s1.students[s1.totIndex].totalMarks.push(marks);
        s1.view=0;
  ...
  render() {
    ...
    return(
     ...
     <Input8c marks={viewIndex>=0 ? total:{}} onSubmitMarks={this.handelSubmitMarks}name={name}/>:""
     }

...
export class input6b extends Component {
  ...
  render() {
    ...
    <label>{this.props.edit?"Edit detail":"Add a cource"}</label>
   ...
   <br/> <button className='btn btn-primary'onClick={this.handelSubmit}>{this.props.edit?"update":"Submit"}</button>
</div>
    </div>
    )
  }

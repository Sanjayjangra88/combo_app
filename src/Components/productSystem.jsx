...
export class productSystem extends Component {
  ...
  render() {
    ...
    return (
        <React.Fragment>
        {(viewGrid === true)?
        <Products products={products} Increment={this.handelIncrement}Decrement={this.handelDecrement}sort={this.sort}view={this.view1}/>:
    
        <ProductTable products={products}Increment={this.handelIncrement}Decrement={this.handelDecrement}sort={this.sort}view={this.view2}/>
  }
        </React.Fragment> 
